  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 bg-site-bg overflow-hidden">
        ...
        />
        {/* Dark gradient overlay for text legibility and aesthetic */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#030508]/95 via-[#030508]/60 to-[#030508]/30" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-site-accent/10 rounded-full blur-[150px] pointer-events-none" />
      </div>
